ALTER TABLE `books` ADD `subjects` text;--> statement-breakpoint
ALTER TABLE `books` ADD `notes` text;--> statement-breakpoint
ALTER TABLE `users` ADD `type` text DEFAULT 'person';--> statement-breakpoint
...
ALTER TABLE `users` ADD `added_by` text;