...
Si vous voulez comprendre plus en détail le fonctionnement de l’appariement local, [la page « comment ça marche »](/how-it-works) détaille l’algorithme des jumeaux d’étagère et l’appariement de proximité. Et si vous songez à organiser quelque chose de plus structuré, [lancer un cercle de prêt de livres dans son quartier](/fr/blog/how-to-start-neighborhood-book-lending-circle) aborde le versant social de ce que biblocal rend possible.
