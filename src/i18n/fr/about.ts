// Page « À propos ». Le français se superpose à l'anglais (src/i18n/ui.ts).
export default {
  meta: {
  ...
  what: {
    ...
    values: {
      community: {
        ...
        body: "Pas d'investisseurs. Pas de publicité. Aucune collecte de données. Juste une chose que nous avons bâtie parce que nous voulions qu'elle existe.",
      },
      openSource: {
        title: 'Code ouvert',
        body: 'Le code est sur GitHub. Forkez-le, améliorez-le, faites tourner le vôtre. Les idées ne demandent qu’à se partager.',
      },
      local: {
        title: 'Hyper-local',
  ...
  help: {
    eyebrow: 'Une petite demande',
    title: 'Aidez-nous à faire passer le mot',
    intro:
      "biblocal ne marche que si les gens s'en servent. Nous n'avons pas de budget marketing : nous vous avons, vous. Si l'idée vous parle, voici comment donner un coup de main :",
    steps: {
      tell: {
        title: 'Parlez-en à un lecteur',
        body: "Pensez à une personne qui adorerait ça. Envoyez-lui un message. C'est tout. Rien ne vaut une recommandation entre amis.",
      },
      share: {
        title: 'Partagez-le quelque part',
        body: "Publiez-en un mot. Tweetez-le. Glissez-le dans le groupe de votre club de lecture. Partout où les lecteurs se rassemblent.",
      },
      bookstore: {
        title: 'Ajoutez votre librairie',
        body: "Vous connaissez une librairie indépendante qui devrait y figurer ? Ajoutez-la. Elle vous remerciera. Nous aussi.",
      },
      build: {
        title: 'Construisez avec nous',
        body: 'Vous codez ? Vous dessinez ? Vous écrivez ? Vous avez des avis sur les métadonnées ? Nous sommes sur GitHub. Les pull requests sont les bienvenues.',
      },
    },
    sharePrompt: 'Copiez ce lien et envoyez-le à quelqu’un qui comprendra :',
    copy: 'Copier',
    copied: 'Copié !',
  },
  why: {
    eyebrow: 'La version longue',
