export default {
  ...
  shelf: {
    ...
    demo: {
      discuss: 'À discuter',
      lend: 'Je prête',
      onShelf: 'Sur mon étagère',
      gift: 'À donner',
      seeking: 'Je cherche',
      notes: {
        smallGods: 'Om est mon philosophe tortue préféré',
        geb: "Vous allez l'adorer ou faire semblant",
        unbearable: 'Chaque lecture révèle autre chose',
        guards: "J'en ai trop d'exemplaires. Un bon problème.",
        dispossessed: "L'utopie ambiguë vous attend",
      },
    },
  },
  facets: {
    ...
    items: {
      shelfTwin: {
        ...
        tagline: 'Des étagères étrangement semblables',
        example: "Vous avez tous les deux ce Calvino que personne ne finit. Vous l'avez tous les deux fini.",
      },
      bookScout: {
        name: 'Éclaireur',
        tagline: 'Ils sont déjà passés par là',
        example: 'Possède trois livres de votre liste un-jour-peut-être',
      },
      neighbor: {
        name: 'Voisin',
        tagline: 'À distance de marche',
        example: 'À 800 mètres. A le livre. Met la bouilloire en route.',
      },
      debatePartner: {
        name: 'Partenaire de débat',
        tagline: 'Le lecteur qui vous contredit',
        example: 'Vous débattrez de Kundera pendant une heure et vous adorerez ça',
      },
      syllabusSurvivor: {
        name: 'Survivant du programme',
        tagline: 'Cicatrices universitaires communes',
        example: "Tous les deux obligés de le lire. Tous les deux l'ont vraiment fait.",
      },
    },
  },
  midCta: {
  ...
  map: {
    ...
    legendYou: 'Vous',
    chromeTitle: 'À moins de 5 km du centre',
    chromeTag: 'En direct',
    books: 'livres',
